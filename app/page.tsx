...
function Icon({ d, size = 24, color = "#22d3ee" }: { d: string; size?: number; color?: string }) {
  return (
...
function GlowDot({ top, left, size, color, delay: delayNum }: { top: string; left: string; size: number; color: string; delay: number }) {
  return (
    <div style={{
